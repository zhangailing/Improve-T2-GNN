...
# Training settings,示例的最佳参数
parser = argparse.ArgumentParser()
parser.add_argument('--name', type=str, default="testrun", help='Provide a test name.')
'''
python run.py --dataset texas --Ts 4.0 --topk 10 --lambd 0.8 --epoch_fea 100 --epoch_str 100 --epoch_stu 100 --repeat 5
python run.py --dataset cornell --Ts 1.0 --topk 5 --lambd 0.9 --epoch_fea 100 --epoch_str 100 --epoch_stu 100 --repeat 5
python run.py --dataset wisconsin --Ts 2.0 --topk 15 --lambd 0.9 --epoch_fea 100 --epoch_str 100 --epoch_stu 100 --repeat 5
python run.py --dataset chameleon --Ts 1.0 --topk 0 --lambd 0.7 --epoch_fea 100 --epoch_str 100 --epoch_stu 100 --repeat 5
python run.py --dataset cora --Ts 5.0 --topk 20 --lambd 0.7 --epoch_fea 100 --epoch_str 100 --epoch_stu 100 --repeat 5
python run.py --dataset citeseer --Ts 5.0 --topk 0 --lambd 0.9 --epoch_fea 100 --epoch_str 100 --epoch_stu 100 --repeat 5
python run.py --dataset squirrel --Ts 2.0 --topk 5 --lambd 0.4 --epoch_fea 100 --epoch_str 100 --epoch_stu 100 --repeat 5
python run.py --dataset pubmed --Ts 1.0 --topk 0 --lambd 0.3 --epoch_fea 100 --epoch_str 100 --epoch_stu 100 --repeat 5
'''
...
parser.add_argument('--min_delta', type=float, default=0.001, help='min_delta')
